        ...
        <div class="row">       
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#drum">Trống Cơ</a></li>
                    <li><a href="#organ">Organ Điện</a></li>
            ...
            <div class="col-md-3 col-lg-3 col-xl-3">
                ...
                <hr class="bg-white mb-2 mt-0 d-inline-block mx-auto w-25">
                <ul class="list-unstyled">
                    <li><i class="fa fa-home mr-2"></i>ĐC: 273 An Dương Vương, Phường 3, Quận 5, TP HCM</li>
                    <li><i class="fa fa-envelope mr-2"></i>Email: sgumusic@gmail.com</li>
                    <li><i class="fa fa-phone mr-2"></i>SĐT: 0123456789</li>
                    <li><i class="fa fa-print mr-2"></i>FAX: 0987654321</li>
                </ul>
            </div>
            ...
            <div class="col text-center border-top">
                <strong>Copyright © 2023 SGU® MUSIC. Powered by Team 13.</strong>
            </div>
        </div>
    </div>
</footer>
<style>
    footer {
        background: linear-gradient(to right, #8A2BE2, #00CED1); /* Mã màu tím đến xanh dương */
        border-radius: 10px;
    }
</style>
